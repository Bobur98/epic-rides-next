...
import { productYears, REACT_APP_API_URL } from '../../libs/config'
...
const ProductDetail: NextPage = ({ initialComment, ...props }: any) => {
	...
	const {
		...
		skip: !productId, // agar productId === null bolsa queryni amalga oshirmaydi
	...
	const likeProductHandler = async (user: T, id: string | undefined) => {
		try {
			if (!id) return
						...
						<Stack className={'product-info-config'}>
							<Stack className={'info'}>
								<Stack className={'left-box'}>
									<Typography className={'title-main'}>{product?.productBrand}</Typography>
									...
									<Stack className={'bottom-box'}>
										<Stack className="option">
											<img width={'15px'} height={'15px'} src="/img/icons/hammer.svg" alt="" />
											<Typography>{product?.productPower} hp</Typography>
										</Stack>
										<Stack className="option">
											<img width={'15px'} height={'15px'} src="/img/icons/gear.svg" alt="" />
											<Typography>{product?.productTorque} Nm</Typography>
										</Stack>
										<Stack className="option">
											<img width={'15px'} height={'15px'} src="/img/icons/calendar.svg" alt="" />
								...
								<Stack className={'right-box'}>
									<Stack className="buttons">
										...
										<Stack className="button-box" onClick={() => likeProductHandler(user, product?._id)}>
							...
							<Stack className={'images'}>
								<Stack className={'main-image'}>
									<img
										src={slideImage ? `${REACT_APP_API_URL}/${slideImage}` : '/img/banner/bgProduct3.jpg'}
										alt={'main-image'}
									/>
								</Stack>
								...
								<Stack className={'options-config'}>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img width={'15px'} height={'15px'} src="/img/icons/piston.svg" />
										</Stack>
										<Stack className={'option-includes'}>
											<Typography className={'title'}>Engine cc</Typography>
											<Typography className={'option-data'}>{product?.productEngineCc}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src={'/img/icons/hammer.svg'} />
										</Stack>
										<Stack className={'option-includes'}>
											<Typography className={'title'}>Power</Typography>
											<Typography className={'option-data'}>{product?.productPower} hp</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{product?.productYear}</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
										...
										<Stack className={'option-includes'}>
											...
											<Typography className={'option-data'}>{product?.productWeight} kg</Typography>
										</Stack>
									</Stack>
									<Stack className={'option'}>
										<Stack className={'svg-box'}>
											<img src="/img/icons/motorcycle.svg" />
										</Stack>
										<Stack className={'option-includes'}>
									...
									<Stack className={'bottom'}>
										...
										<Stack className={'info-box'}>
											<Stack className={'left'}>
												...
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product Brand</Typography>
												...
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product Year</Typography>
													<Typography className={'data'}>{product?.productYear}</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product Engine</Typography>
													<Typography className={'data'}>{product?.productEngine}</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product cc</Typography>
													<Typography className={'data'}>{product?.productEngineCc}</Typography>
												</Box>
											</Stack>
											<Stack className={'right'}>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product Power</Typography>
													<Typography className={'data'}>{product?.productPower} hp</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product Torque</Typography>
													<Typography className={'data'}>{product?.productTorque} Nm</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product Weight</Typography>
													<Typography className={'data'}>{product?.productWeight} kg</Typography>
												</Box>
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product Condition</Typography>
													<Typography className={'data'}>{product?.productCondition}</Typography>
												</Box>
												...
												<Box component={'div'} className={'info'}>
													<Typography className={'title'}>Product Address</Typography>
													<Typography className={'data'}>{product?.productAddress}</Typography>
												</Box>
											</Stack>
										</Stack>
									</Stack>
							...
							<Stack className={'similar-products-config'}>
								<Stack className={'title-pagination-box'}>
									<Stack className={'title-box'}>
										<Typography className={'main-title'}>Recommended Products</Typography>
										<Typography className={'sub-title'}>Discover Items You May Also Like</Typography>
									</Stack>
								...
								<Stack className={'cards-box'}>
									...
									>
										{destinationProducts.map((product: Product) => {
											return (
												<SwiperSlide className={'similar-homes-slide'} key={product._id}>
													<ProductBigCard
														product={product}
														key={product?._id}
